...
input double TAKE_PROFIT = 0;                           // ├利確価格幅
input double STOP_LOSS = 500;                           // ├損切価格幅
input double TRAILING_STOP = 20;                        // ├トレーリングストップ価格幅
input bool ENABLE_LOSE_RE_ENTRY = false;                // ├負けトレンドの後の再エントリーの許可
