...
sinput ENUM_TRAILING_TYPE TRAILING_TYPE = TRAILING_TYPE_WITH_TP;    // ├トレーリングストップ種別
sinput int TRAILING_STOP_INTERVAL_SECONDS = 13;                     // ├トレーリングストップ更新間隔(秒)
input double TRAILING_TAKE_PROFIT = 200;                            // ├トレーリングストップ利確価格幅
input double TRAILING_STOP_LOSS = 100;                              // └トレーリングストップ損切価格幅
